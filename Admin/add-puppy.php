...
if(isset($_POST['insert_puppy'])){
    ...
    if($puppy_title==''or $puppy_Age==''or $puppy_Gender=='' or $puppy_description==''or $puppy_breed=='' or $puppy_image1=='' or $puppy_image2=='' or $puppy_image3=='' or $puppy_price==''){
        ...
        // insert query
        $insert_puppy_query="insert into `puppies` (puppy_title,puppy_age,puppy_gender,puppy_desc,puppy_location,Owner_name,Owner_contact,breed_title,P_image_one,P_image_two,P_image_three,puppy_price,date) values('$puppy_title','$puppy_Age','$puppy_Gender','$puppy_description',
...
<body class="bg-light">
 ...
 <div class="container text-center ">
    <h2 class="text-warning mb-4">Add new puppy</h2>
    <!-- form -->
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-2 w-50 m-auto">
            ...
            <input type="text" name="puppy_age" id="puppy_age" class="form-control"
              autocomplete="off" required="required">
        </div>
        <!-- puppy gender -->
        <div class="form-outline mb-2 w-50 m-auto">
            <label for="puppy_gender"class="form-label ">Gender</label>
            <input type="text" name="puppy_gender" id="puppy_gender" class="form-control"
              autocomplete="off" required="required">
        </div>
        ...
        <div class="form-outline mb-2 w-50 m-auto">
         ...
         <div class="form-outline mb-2 w-50 d-grid m-auto">
            <input type="submit" value="Insert puppy" class="btn btn-outline-warning" name="insert_puppy">
        </div>
    </form>
 </div>
